...
namespace Pulumi.AzureStorageStaticSite
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureStorageStaticSite.version.txt");
    ...
    internal sealed class AzureStorageStaticSiteResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
        public AzureStorageStaticSiteResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
