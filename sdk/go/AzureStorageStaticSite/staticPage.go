...
package AzureStorageStaticSite
...
type StaticPage struct {
	...
	// The CDN URL.
	CdnUrl pulumi.StringOutput `pulumi:"cdnUrl"`
	// The bucket resource.
	StorageAccount storage.StorageAccountOutput `pulumi:"storageAccount"`
	// The website URL.
...
func NewStaticPage(ctx *pulumi.Context,
	...
	err := ctx.RegisterRemoteComponentResource("AzureStorageStaticSite:index:StaticPage", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
